    ...
    <section className="bg-transparent py-16 px-4" id="trust-bar">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-sans font-extrabold text-neutral-900 tracking-tight mb-3">
            Why Shop Burak Mart?
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {items.map((item, i) => (
            ...
            >
              ...
              <h3 className="text-lg font-sans font-extrabold text-neutral-900 mb-3 tracking-tight">
                {item.title}
              </h3>
